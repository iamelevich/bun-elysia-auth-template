...
type AlertDialogActions = AlertDialogPrimitive.Root.Actions;
...
AlertDialog.createHandle = AlertDialogPrimitive.createHandle;

type AlertDialogHandle = ReturnType<typeof AlertDialog.createHandle>;
...
export type { AlertDialogActions, AlertDialogTriggerProps, AlertDialogHandle };
